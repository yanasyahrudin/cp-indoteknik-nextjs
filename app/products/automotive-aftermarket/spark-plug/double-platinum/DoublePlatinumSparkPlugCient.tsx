...
import categories from '../../../../data/sparkSplugCategory'; // Update to appropriate data source if needed
...
const DoublePlatinumSparkPlugDetails = () => {
...
export default DoublePlatinumSparkPlugDetails;
