...
const SparkPlugCategories = () => {
    ...
    const filteredSparkPlugs =
        activeTab === 'All'
            ? categories
            : categories.filter((sparkPlug) => sparkPlug.type === activeTab);
    ...
    return (
        <div className='mt-10 mb-20 max-w-6xl mx-auto'>
            ...
            <div className='flex justify-center space-x-4 mt-8'>
                {['All', 'Iridium', 'Platinum', 'Performance'].map((tab) => (
                    <button
                        key={tab}
...
export default SparkPlugCategories;
