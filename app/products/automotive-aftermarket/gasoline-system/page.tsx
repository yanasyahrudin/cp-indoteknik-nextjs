...
const GasolineSystemCategory = () => {
    ...
    return (
        <div className='mt-10 mb-20 max-w-6xl mx-auto'>
            <Head>
                <title>{t('Gasoline System Category')} | Indo Teknik</title>
                <meta
                    name='description'
                    content={t(
                ...
                <meta
                    name='keywords'
                    content={`${t('Gasoline System Category')}, ${t('Gasoline System Category')} Indo Teknik, Bosch`}
                />
            </Head>

            <h1 className='text-center font-bold text-3xl text-blue-900 animate-bounceIn'>
                {t('Gasoline System Category')}
            </h1>
            <div className='flex justify-center space-x-4 mt-8'>
                {['All', 'Fuel', 'Ignition'].map((tab) => (
                    <button
                        key={tab}
...
export default GasolineSystemCategory;
