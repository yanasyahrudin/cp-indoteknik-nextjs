...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721619185/cp-indoteknik-v3/productsRelay/Bosch-4-pin-relay-768x513_rthrg1.png', // Replace with actual image URL
};
...
export default FourPinRelayDetails;
