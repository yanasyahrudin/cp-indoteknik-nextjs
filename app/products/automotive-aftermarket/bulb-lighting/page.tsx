...
const BulbsLightingCategories = () => {
    ...
    return (
        <div className='mt-10 mb-20 max-w-6xl mx-auto'>
            <Head>
                <title>{t('Bulb and Lighting Category')} | Indo Teknik</title>
                <meta
                    name='description'
                    content={t(
                ...
                <meta
                    name='keywords'
                    content={`${t('Bulb and Lighting Category')}, ${t('Bulb and Lighting Category')} Indo Teknik, Bosch`}
                />
            </Head>
            <h1 className='text-center font-bold text-3xl text-blue-900 animate-bounceIn'>
                {t('Bulb and Lighting Category')}
            </h1>
...
export default BulbsLightingCategories;
