...
export const metadata = {
    ...
    alternates: {
        canonical: 'https://indo-teknik.com/products/automotive-aftermarket/wiper/eco-plus',
    },
    openGraph: {
        title: `${categoryDetails.name} | Indo Teknik`,
        description: `Telusuri kategori ${categoryDetails.name} untuk komponen otomotif dan mesin berkualitas terbaik. Temukan informasi detail tentang ${categoryDetails.name} dan suku cadang terkait di Indo Teknik.`,
...
const shuffleArray = (array) => {
    ...
    return <EcoPlusWiperDetails shuffledCategories={shuffledCategories} jsonLd={jsonLd} categoryDetails={categoryDetails} />;
}