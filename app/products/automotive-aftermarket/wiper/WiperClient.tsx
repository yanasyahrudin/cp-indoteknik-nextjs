...
const WiperCategories = () => {
    ...
    return (
        <div className='mt-10 mb-20 max-w-6xl mx-auto'>
            <Head>
                <title>{t('Wiper Category')} | Indo Teknik</title>
                <meta
                    name='description'
                    content={t(
                ...
                <meta
                    name='keywords'
                    content={`${t('Wiper Category')}, ${t('Wiper Category')} Indo Teknik, Bosch`}
                />
            </Head>
...
export default WiperCategories;
