...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1723107502/cp-indoteknik-v3/productsHorn/motorcycle_mini-removebg-preview_phzzyt.png', // Replace with actual image URL
};
...
const MotorcycleMiniHornDetails = () => {
...
export default MotorcycleMiniHornDetails;
