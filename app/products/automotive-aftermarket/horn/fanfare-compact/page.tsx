...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1723107502/cp-indoteknik-v3/productsHorn/fanfare_compact-removebg-preview_rulysx.png',
};
...
export const metadata = {
    ...
    openGraph: {
        title: `${categoryDetails.name} | Indo Teknik`,
        description: `Telusuri kategori ${categoryDetails.name} untuk komponen otomotif dan mesin berkualitas terbaik. Temukan informasi detail tentang ${categoryDetails.name} dan suku cadang terkait di Indo Teknik.`,
        url: 'https://indo-teknik.com/products/automotive-aftermarket/horn/fanfare-compact',
        type: 'website',
        images: [
            {
