...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1724659560/cp-indoteknik-v3/productsTurboCharger/Cartidge_Turbo_HX35_xjxzxy.png', // Replace with actual image URL
};
...
export default CartridgeTurboDetails;
