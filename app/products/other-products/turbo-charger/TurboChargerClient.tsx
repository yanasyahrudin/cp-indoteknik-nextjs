...
const TurboChargerCategories = () => {
    ...
    return (
        <div className='mt-10 mb-20 max-w-6xl mx-auto'>
            <Head>
                <title>{t('Turbo Charger Category')} | Indo Teknik</title>
                <meta
                    name='description'
                    content={t(
                ...
                <meta
                    name='keywords'
                    content={`${t('Turbo Charger Category')}, ${t('Turbo Charger Category')} Indo Teknik, Garrett, Itech`}
                />
            </Head>

            <h1 className='text-center font-bold text-3xl text-blue-900 animate-bounceIn'>
                {t('Turbo Charger Category')}
            </h1>
...
export default TurboChargerCategories;
