...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721360636/cp-indoteknik-v3/productsTurboCharger/DSC_0331-removebg-preview_kjdaw2.png', // Replace with actual image URL
};
...
export default RepairKitTurboDetails;
