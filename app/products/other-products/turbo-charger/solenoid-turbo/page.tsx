...
import categories from '../../../../data/turboChargerCategory'; // Update to the appropriate category data if needed
...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1724723032/cp-indoteknik-v3/productsTurboCharger/Actuator_Vacum_turbo_Ford_XLT_XLS_IMG_20230824_142812-removebg-preview_rylxy4.png', // Replace with actual image URL
};
...
export default SolenoidTurboDetails;
