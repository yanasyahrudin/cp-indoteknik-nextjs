...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1723780076/cp-indoteknik-v3/productsPowerTool/GBM_400_Bor_Bosch_-removebg-preview_x9luvj.png', // Replace with actual image URL
};
...
export default ElectricDrillDetails;
