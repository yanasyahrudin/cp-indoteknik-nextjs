...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1723780076/cp-indoteknik-v3/productsPowerTool/Gerinda_Listrik_GWS-removebg-preview_d69m1d.png', // Replace with actual image URL
};
...
export default ElectricGrinderDetails;
