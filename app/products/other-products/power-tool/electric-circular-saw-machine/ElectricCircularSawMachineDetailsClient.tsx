...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1723780532/cp-indoteknik-v3/productsPowerTool/br-m036969-00486_bosch-circular-saw-gergaji-sirkel-listrik-184mm-1300watt-gks-130_full01-645ce84b-removebg-preview_toihfg.png', // Replace with actual image URL
};
...
const ElectricCircularSawMachineDetails = () => {
...
export default ElectricCircularSawMachineDetails;
