...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1723780076/cp-indoteknik-v3/productsPowerTool/Bor_Beton_Listrik_2kG-removebg-preview_fjs01n.png', // Replace with actual image URL
};
...
const ElectricConcreteDrillDetails = () => {
...
export default ElectricConcreteDrillDetails;
