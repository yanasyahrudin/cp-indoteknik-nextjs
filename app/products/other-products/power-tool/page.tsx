...
const PowerToolCategories = () => {
    ...
    return (
        <div className='mt-10 mb-20 max-w-6xl mx-auto'>
            <Head>
                <title>{t('Power Tool Category')} | Indo Teknik</title>
                <meta
                    name='description'
                    content={t(
                ...
                <meta
                    name='keywords'
                    content={`${t('Power Tool Category')}, ${t('Power Tool Category')} Indo Teknik, Bosch`}
                />
            </Head>

            <h1 className='text-center font-bold text-3xl text-blue-900 animate-bounceIn'>
                {t('Power Tool Category')}
            </h1>
            <div className='grid grid-cols-2 gap-4 md:flex md:justify-center md:space-x-0 mt-8 mr-4 ml-4'>
                {['All', 'Power Tool', 'Measuring Tool', 'Garden Tool'].map(
                    (tab) => (
                        <button
                            key={tab}
...
export default PowerToolCategories;
