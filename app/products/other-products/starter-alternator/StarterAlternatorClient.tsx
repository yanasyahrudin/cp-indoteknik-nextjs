...
const StarterAlternatorCategories = () => {
    ...
    return (
        <div className='mt-10 mb-20 max-w-6xl mx-auto'>
            <Head>
                <title>
                    {t('Starter and Alternator Category')} | Indo Teknik
                </title>
                <meta
                    name='description'
                    content={t(
                ...
                <meta
                    name='keywords'
                    content={`${t('Starter and Alternator Category')}, ${t('Starter and Alternator Category')} Indo Teknik, Bosch`}
                />
            </Head>

            <h1 className='text-center font-bold text-3xl text-blue-900 animate-bounceIn'>
                {t('Starter and Alternator Category')}
            </h1>
            <div className='flex justify-center space-x-4 mt-8'>
                {['All', 'Starter', 'Alternator'].map((tab) => (
                    <button
                        key={tab}
...
export default StarterAlternatorCategories;
