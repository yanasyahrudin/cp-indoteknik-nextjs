...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1724812872/cp-indoteknik-v3/productsSocket/Soket_Selenoid_valve_hidrolik-removebg-preview_p5d0xb.png', // Replace with actual image URL
};
...
const SolenoidValveHydraulicSocketDetails = () => {
...
export default SolenoidValveHydraulicSocketDetails;
