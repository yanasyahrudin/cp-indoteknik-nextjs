...
import categories from '../../../../data/socketCategory'; // Update to the appropriate category data if needed 
...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1724812872/cp-indoteknik-v3/productsSocket/Soket_Oil_Temperature_Sensor_Denso-removebg-preview_udhaxg.png', // Replace with actual image URL
};
...
const OilTemperatureSensorSocketDetails = () => {
...
export default OilTemperatureSensorSocketDetails;
