...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1724839443/cp-indoteknik-v3/productsTools/TOOL_INJECTOR_DENSO_3_PINS_DSC_0815_maqcxw_u89aeb_wgksp5.png', // Replace with actual image URL
};
...
export default ToolInjectorDetails;
