...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721964088/cp-indoteknik-v3/productsTools/tools_set_injector_DSC_0378_copy-removebg-preview_wtdx2p.png', // Replace with actual image URL
};
...
export default InjectorToolSetDetails;
