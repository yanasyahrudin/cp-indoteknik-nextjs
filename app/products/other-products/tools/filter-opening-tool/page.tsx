...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1724839443/cp-indoteknik-v3/productsTools/TOOL_PEMBUKA_FILTER_DENSO_DSC_0003-removebg-preview_k0jsku_xxpdmb_zakp67.png', // Replace with actual image URL
};
...
const FilterOpeningToolDetails = () => {
...
export default FilterOpeningToolDetails;
