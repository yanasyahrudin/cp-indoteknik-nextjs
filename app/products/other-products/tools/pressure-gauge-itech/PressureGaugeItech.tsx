...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1724839442/cp-indoteknik-v3/productsTools/Pressure_Gauge_Itech_DSC_0574b_copy_ttwser_moncb2_ckf4b4.png', // Replace with actual image URL
};
...
const PressureGaugeItechDetails = () => {
...
export default PressureGaugeItechDetails;
