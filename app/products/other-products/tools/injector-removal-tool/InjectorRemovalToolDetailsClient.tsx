...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721964747/cp-indoteknik-v3/productsTools/DSC_1282-removebg-preview_pnjpsn.png', // Replace with actual image URL
};
...
const InjectorRemovalToolDetails = () => {
...
export default InjectorRemovalToolDetails;
