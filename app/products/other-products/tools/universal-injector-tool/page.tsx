...
const categoryDetails = {
    ...
    description: descriptionDetailCategory, imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721965348/cp-indoteknik-v3/productsTools/universal_injector_tool_azxyuz.png', // Replace with actual image URL
};
...
const UniversalInjectorToolDetails = () => {
...
export default UniversalInjectorToolDetails;
