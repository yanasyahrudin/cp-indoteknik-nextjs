...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721963857/cp-indoteknik-v3/productsTools/opener_seal_kit_uxbjzm.png', // Replace with actual image URL
};
...
const SealKitRemovalToolDetails = () => {
...
export default SealKitRemovalToolDetails;
