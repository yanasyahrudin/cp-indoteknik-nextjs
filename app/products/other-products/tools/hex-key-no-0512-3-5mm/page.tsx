...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1724839447/cp-indoteknik-v3/productsTools/KUNCI_HEX_KEY_no.0512_3.5MM_DSC_0562-removebg-preview_dlsple_smbaj0.png', // Replace with actual image URL
};
...
const HexKeyNo05123_5MMDetails = () => {
...
export default HexKeyNo05123_5MMDetails;
