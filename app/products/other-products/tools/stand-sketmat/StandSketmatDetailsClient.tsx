...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1724839441/cp-indoteknik-v3/productsTools/Stand_Sketmad_And_Sketmad_DSC_0116_copy_f6uzxj_z8qjow_arvps0.png', // Replace with actual image URL
};
