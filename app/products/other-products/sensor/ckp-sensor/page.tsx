...
const categoryDetails = {
    ...
    description: descriptionDetailCategory, imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721363834/cp-indoteknik-v3/productsSensor/DSC_0160b-removebg-preview_d27pkp.png', // Replace with actual image URL
};
...
export default CkpSensorDetails;
