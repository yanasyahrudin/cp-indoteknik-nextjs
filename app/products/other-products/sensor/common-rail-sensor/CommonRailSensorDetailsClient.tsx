...
import categories from '../../../../data/sensorCategory'; // Update to the appropriate category data if needed
...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721363366/cp-indoteknik-v3/productsSensor/DSC_0596-removebg-preview_qmjwme.png', // Replace with actual image URL
};
...
export default CommonRailSensorDetails;
