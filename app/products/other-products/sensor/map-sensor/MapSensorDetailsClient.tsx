...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721363673/cp-indoteknik-v3/productsSensor/DSC_0747-removebg-preview_nbltym.png', // Replace with actual image URL
};
...
export default MapSensorDetails;
