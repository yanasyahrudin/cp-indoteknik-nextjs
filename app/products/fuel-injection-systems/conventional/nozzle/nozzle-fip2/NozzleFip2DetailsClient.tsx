...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721881115/cp-indoteknik-v3/productsNozzle/DSC_0651-removebg-preview_qphkvt.png', // Replace with actual image URL
};
...
export default NozzleFIP2Details;
