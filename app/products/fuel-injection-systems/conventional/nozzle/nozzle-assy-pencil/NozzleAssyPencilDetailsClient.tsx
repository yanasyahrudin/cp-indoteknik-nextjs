...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721880467/cp-indoteknik-v3/productsNozzle/nozzle_assy_DSC_0166b-removebg-preview_ryuzfm.png', // Replace with actual image URL
};
...
export default NozzleAssyPencilDetails;
