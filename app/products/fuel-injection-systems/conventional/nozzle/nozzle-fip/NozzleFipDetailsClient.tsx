...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721881114/cp-indoteknik-v3/productsNozzle/DSC_0314b-removebg-preview_vezxbp.png', // Replace with actual image URL
};
...
export default NozzleFIPDetails;
