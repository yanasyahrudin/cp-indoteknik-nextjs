...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721881115/cp-indoteknik-v3/productsNozzle/DSC_0275-removebg-preview_eypeg8.png', // Replace with actual image URL
};
...
export default NozzleFIP3Details;
