...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721880466/cp-indoteknik-v3/productsNozzle/nozzle_assy_DSC_0510-removebg-preview_nfcigk.png', // Replace with actual image URL
};
...
const NozzleAssyInjector2Details = () => {
...
export default NozzleAssyInjector2Details;
