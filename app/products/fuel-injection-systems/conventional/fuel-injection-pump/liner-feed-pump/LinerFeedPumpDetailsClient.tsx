...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,
       imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721447681/cp-indoteknik-v3/productsFuelInjectionPump/rotary/Liner_Feedpump-removebg-preview_qf17co.png', // Replace with actual image URL
};


const LinerFeedpumpDetails = ({ shuffledCategories, categoryDetails, jsonLd }) => {
...
export default LinerFeedpumpDetails;
