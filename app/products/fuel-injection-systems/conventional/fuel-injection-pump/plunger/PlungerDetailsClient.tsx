...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721447766/cp-indoteknik-v3/productsFuelInjectionPump/in-line/Plunger-removebg-preview_vkflsm.png', // Replace with actual image URL
};
