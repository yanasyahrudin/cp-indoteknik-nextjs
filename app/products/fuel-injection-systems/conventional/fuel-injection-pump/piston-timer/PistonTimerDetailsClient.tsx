...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721456497/cp-indoteknik-v3/productsFuelInjectionPump/rotary/piston_timer_y6lzqw.png', // Replace with actual image URL
};
...
export default PistonTimerDetails;
