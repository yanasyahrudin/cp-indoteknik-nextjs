...
export const metadata = {
    ...
    alternates: {
        canonical:
            'https://indo-teknik.com/products/fuel-injection-systems/conventional/fuel-injection-pump/piston-timer',
    },
};
...
const shuffleArray = (array) => {
   ...
   const filteredCategories = categories.filter(
    ...
    return <PistonTimerDetailsClient shuffledCategories={shuffledCategories} categoryDetails={categoryDetails} jsonLd={jsonLd} />;
}