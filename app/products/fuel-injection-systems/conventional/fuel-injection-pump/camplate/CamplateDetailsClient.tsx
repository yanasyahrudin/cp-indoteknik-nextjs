...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,
      imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721447682/cp-indoteknik-v3/productsFuelInjectionPump/rotary/Camplate-removebg-preview_gbuogr.png', // Replace with actual image URL
};
...
export default CamplateDetails;
