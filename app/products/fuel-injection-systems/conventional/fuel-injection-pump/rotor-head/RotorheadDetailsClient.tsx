...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721447680/cp-indoteknik-v3/productsFuelInjectionPump/rotary/Rotorhead-removebg-preview_onliuz.png', // Replace with actual image URL
};
...
export default RotorheadDetails;
