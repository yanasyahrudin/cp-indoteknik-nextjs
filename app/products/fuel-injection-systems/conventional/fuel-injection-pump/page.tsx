...
const FuelInjectionPumpCategories = () => {
    ...
    return (
        <div className='mt-10 mb-20 max-w-6xl mx-auto'>
            <Head>
                <title>{t('Fuel Injection Pump Category')} | Indo Teknik</title>
                <meta
                    name='description'
                    content={t(
                ...
                <meta
                    name='keywords'
                    content={`${t('Fuel Injection Pump Category')}, ${t('Fuel Injection Pump Category')} Indo Teknik, Bosch, Itech, Zexel`}
                />
            </Head>
