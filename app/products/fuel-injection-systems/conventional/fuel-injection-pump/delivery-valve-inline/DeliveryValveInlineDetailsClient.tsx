...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721447771/cp-indoteknik-v3/productsFuelInjectionPump/in-line/Delivery_Valve-removebg-preview_iyax79.png', // Replace with actual image URL
};
...
const DeliveryValveInlineDetails = () => {
...
export default DeliveryValveInlineDetails;
