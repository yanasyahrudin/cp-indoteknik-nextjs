...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721456160/cp-indoteknik-v3/productsFuelInjectionPump/rotary/coupling_nqpbri.png', // Replace with actual image URL
};
...
export default CouplingDetails;
