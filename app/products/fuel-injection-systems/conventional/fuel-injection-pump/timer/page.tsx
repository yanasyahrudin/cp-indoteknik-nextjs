...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/c_scale,w_600/v1721794913/cp-indoteknik-v3/productsFuelInjectionPump/in-line/timer_r5dbcl.png', // Replace with actual image URL
};
