...
export const metadata = {
    ...
    alternates: {
        canonical:
            'https://indo-teknik.com/products/fuel-injection-systems/conventional/fuel-injection-pump/spring-rotary',
    },
};
...
const shuffleArray = (array) => {
   ...
   const filteredCategories = categories.filter(
    ...
    return <SpringRotaryDetailsClient shuffledCategories={shuffledCategories} categoryDetails={categoryDetails} jsonLd={jsonLd} />;
}