...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721463483/cp-indoteknik-v3/productsFuelInjectionPump/rotary/spring_rotary_uk85st.png', // Replace with actual image URL
};
...
export default SpringRotaryDetails;
