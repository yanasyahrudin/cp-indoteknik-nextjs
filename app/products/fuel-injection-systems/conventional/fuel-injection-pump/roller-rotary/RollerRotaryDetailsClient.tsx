...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721462503/cp-indoteknik-v3/productsFuelInjectionPump/rotary/roller_rotary-removebg-preview_mhkuke.png', // Replace with actual image URL
};
...
export default RollerRotaryDetails;
