...
export const metadata = {
    ...
    alternates: {
        canonical:
            'https://indo-teknik.com/products/fuel-injection-systems/conventional/fuel-injection-pump/handpump',
    },
};
...
const shuffleArray = (array) => {
   ...
   const filteredCategories = categories.filter(
    ...
    return <HandpumpDetailsClient shuffledCategories={shuffledCategories} categoryDetails={categoryDetails} jsonLd={jsonLd} />;
}