...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/c_scale,w_600/v1721447704/cp-indoteknik-v3/productsFuelInjectionPump/rotary/Delivery_Valve_pbocxp.png', // Replace with actual image URL
};
...
const DeliveryValveRotaryDetails = () => {
...
export default DeliveryValveRotaryDetails;
