...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721448706/cp-indoteknik-v3/productsFuelInjectionPump/in-line/Bushing-removebg-preview_djqjhz.png', // Replace with actual image URL
};
...
const BushingDetails = () => {
    ...
    // Deskripsi meta dan kata kunci yang dihasilkan secara dinamis
