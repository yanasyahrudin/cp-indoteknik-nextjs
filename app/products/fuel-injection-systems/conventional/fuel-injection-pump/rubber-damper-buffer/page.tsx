...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721447767/cp-indoteknik-v3/productsFuelInjectionPump/in-line/Karet_Damper_Buffer-removebg-preview_f3wozx.png', // Replace with actual image URL
};
...
const RubberDamperBufferDetails = () => {
...
export default RubberDamperBufferDetails;
