...
export const metadata = {
    ...
    alternates: {
        canonical:
            'https://indo-teknik.com/products/fuel-injection-systems/conventional/fuel-injection-pump/camshaft',
    },
};
...
const filteredCategories = categories.filter(
    ...
    return <CamshaftDetailsClient shuffledCategories={shuffledCategories} jsonLd={jsonLd} categoryDetails={categoryDetails} />;
}