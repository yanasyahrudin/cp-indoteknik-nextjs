...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1724831488/cp-indoteknik-v3/productsInjetcor/control_valve_DSC_0580b-removebg-preview_bba9q3.png', // Replace with the appropriate image URL
};
...
export default ControlValveDetails;
