...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/c_scale,w_600/v1721612428/cp-indoteknik-v3/productsInjetcor/shim_calibration_las2lz.png', // Replace with the appropriate image URL
};
...
const ShimCalibrationInjectorDetails = () => {
...
export default ShimCalibrationInjectorDetails;
