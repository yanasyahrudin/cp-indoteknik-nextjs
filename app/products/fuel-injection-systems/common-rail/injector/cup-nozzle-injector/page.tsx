...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/c_scale,w_600/v1721206188/cp-indoteknik-v3/productsInjetcor/DSC_0694_copy_ujmdkj.png', // Replace with the appropriate image URL
};
...
const CupNozzleInjectorDetails = () => {
...
export default CupNozzleInjectorDetails;
