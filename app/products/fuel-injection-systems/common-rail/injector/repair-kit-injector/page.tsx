...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/w_600/v1731996652/cp-indoteknik-v3/productsInjetcor/DSC_0165b_copy_bcn6vm.png', // Replace with actual image URL
};
...
const RepairKitInjectorDetails = () => {
...
export default RepairKitInjectorDetails;
