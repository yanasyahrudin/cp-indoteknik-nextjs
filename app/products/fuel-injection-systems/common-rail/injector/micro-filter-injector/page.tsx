...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1733110204/cp-indoteknik-v3/productsInjetcor/micro_filter_hx6vlr.png', // Replace with actual image URL
};
...
const MicroFilterInjectorDetails = () => {
...
export default MicroFilterInjectorDetails;
