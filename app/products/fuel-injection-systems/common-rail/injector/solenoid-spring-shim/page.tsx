...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721616553/cp-indoteknik-v3/productsInjetcor/solenoid_spring_shim_b24-removebg-preview_yfxkbv.png', // Replace with the appropriate image URL
};
...
const SolenoidSpringShimDetails = () => {
...
export default SolenoidSpringShimDetails;
