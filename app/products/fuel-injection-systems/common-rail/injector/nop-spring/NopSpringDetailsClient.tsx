...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/c_scale,w_600/v1721468262/cp-indoteknik-v3/productsInjetcor/nop_spring_injector_gbbayp.png', // Replace with the appropriate image URL
};
...
export default NopSpringDetails;
