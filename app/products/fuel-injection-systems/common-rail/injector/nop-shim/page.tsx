...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721615996/cp-indoteknik-v3/productsInjetcor/nop_shim-removebg-preview_k9setq.png', // Update with the appropriate image URL
};
...
export default NopShimInjectorDetails;
