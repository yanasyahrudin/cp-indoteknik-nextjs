...
const categoryDetails = {
    ...
    imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/c_scale,w_600/v1721357271/cp-indoteknik-v3/productsSupplyPump/gvasy7g7a8s_kmfyir.png', // Replace with actual image URL
};
