...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/c_scale,w_600/v1721372991/cp-indoteknik-v3/productsSupplyPump/1613533740511_copy_rsighv.png', // Replace with actual image URL
};  
...
const TemperatureSensorDetails = () => {
