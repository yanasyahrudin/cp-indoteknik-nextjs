...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1725093485/cp-itech/categories/supplyPump/DSC_0023b-removebg-preview_oxaaul_ylxvt0.png', // Replace with actual image URL
};
...
const ValvePressureRegulatorDetails = () => {
...
export default ValvePressureRegulatorDetails;
