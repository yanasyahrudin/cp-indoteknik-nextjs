...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1724838119/cp-indoteknik-v3/productsSupplyPump/Selang_Pipa_Supply_Pump_Tryton_DSC_0888b-removebg-preview_blkpk6.png', // Replace with actual image URL
};
...
export default PipeHoseDetails;
