...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1724838119/cp-indoteknik-v3/productsSupplyPump/nepel_plunger_DSC_0219-removebg-preview_p2kej8.png', // Replace with actual image URL
};
...
const NepelPlungerSupplyPumpDetails = () => {
...
export default NepelPlungerSupplyPumpDetails;
