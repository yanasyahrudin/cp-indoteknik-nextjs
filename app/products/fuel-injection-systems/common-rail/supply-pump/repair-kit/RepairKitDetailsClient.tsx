...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721372147/cp-indoteknik-v3/productsSupplyPump/DSC_0861_copy-removebg-preview_upvqsl.png', // Replace with actual image URL
};
...
const RepairKitSupplyPumpDetails = () => {
...
export default RepairKitSupplyPumpDetails;
