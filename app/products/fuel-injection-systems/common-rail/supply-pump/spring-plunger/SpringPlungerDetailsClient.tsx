...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1727409308/cp-indoteknik-v3/productsSupplyPump/spring_plunger_sp_wfy8zg.png', // Replace with actual image URL
};
...
export default SpringPlungerDetails;
