...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,  imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1721372685/cp-indoteknik-v3/productsSupplyPump/DSC_0122b-removebg-preview_x9f6dm.png', // Replace with actual image URL
};
...
export default RotorSetFeedPumpDetails;
