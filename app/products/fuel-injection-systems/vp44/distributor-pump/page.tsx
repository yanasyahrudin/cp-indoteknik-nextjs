...
const DistributorPumpCategories = () => {
    ...
    return (
        <div className='mt-10 mb-20 max-w-6xl mx-auto'>
            <Head>
                <title>{t('Distributor Pump Category')} | Indo Teknik</title>
                <meta
                    name='description'
                    content={t(
                ...
                <meta
                    name='keywords'
                    content={`${t('Distributor Pump Category')}, ${t(
                        'Distributor Pump Category'
                    )} Indo Teknik, Zexel`}
                />
            </Head>
            <h1 className='text-center font-bold text-3xl text-blue-900 animate-bounceIn'>
                {t('Distributor Pump Category')}
            </h1>
...
export default DistributorPumpCategories;
