...
const DistributorPumpVP44Details = () => {
    ...
    const metaKeywords = `${categoryDetails.name}, komponen otomotif, part diesel, Indo Teknik, Pump VP44`;
...
export default DistributorPumpVP44Details;
