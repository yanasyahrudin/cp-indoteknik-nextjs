...
import december2024Blog from "./translations/blog/december2024.json";
import november2024Blog from "./translations/blog/november2024.json";
import october2024Blog from "./translations/blog/october2024.json";
import utilityBlog from "./translations/blog/utilityBlog.json";
...
i18next.init({
  ...
  resources: {
    en: {
      global: global_en,
      dec2024Blog: december2024Blog,
      nov2024Blog: november2024Blog,
      oct2024Blog: october2024Blog,
      blog: utilityBlog,
    },
    id: {
      global: global_id,
            translation: {
                ...
                'Location': 'Lokasi',
                'Common Rail Pipe': 'Pipa Common Rail',
                'Common Rail Pipe Category': 'Kategori Pipa Common Rail'
            }
    },
  },
});
...
export default function I18nProvider({
  ...
  // Sederhana: render children walau belum siap, atau bisa kembalikan null/skeleton
