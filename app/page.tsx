...
export const metadata = {
    ...
    twitter: {
        ...
        title: 'Beranda | Indo Teknik',
        description: 'Pusat servis dan distributor spare part diesel terpercaya di Pekanbaru. Layanan lengkap untuk mesin diesel, injector, supply pump, fabrikasi, dan automotive aftermarket.',
        images: [
