...
const Injector = () => {
    ...
    return (
        <div className='mx-auto mt-10 mb-10'>
            <Head>
                <title>{t('services.injector.title')} | Indo Teknik</title>
                <meta
                    name='description'
                    content={t('services.injector.imageDescription')}
                />
                <meta
                    name='keywords'
                    content={`${t('services.injector.title')}, ${t(
                        'header.services'
                    )} ${t('services.injector.title')}, ${t(
                        'header.services'
                    )} Indo Teknik`}
                />
            </Head>
                        ...
                        <div className='sm:p-4 p-2 sm:w-full flex flex-col justify-between'>
                            <div>
                                <p className='mt-2 text-md text-gray-800 text-justify'>
                                    {t('services.injector.description')}
                                </p>
                                <ul className='list-disc list-inside mt-2 text-gray-700'>
                                    <li className='flex items-start'>
                                        <IoIosSettings className='mr-2 text-blue-900 w-5 h-5' />
                                        {t(
                                            'services.injector.services.diagnosis'
                                        )}
                                    </li>
                                    <li className='flex items-start'>
                                        <IoIosSettings className='mr-2 text-blue-900 w-5 h-5' />
                                        {t(
                                            'services.injector.services.maintenance'
                                        )}
                                    </li>
                                    <li className='flex items-start'>
                                        <IoIosSettings className='mr-2 text-blue-900 w-5 h-5' />
                                        {t(
                                            'services.injector.services.testing'
                                        )}
                                    </li>
                                    <li className='flex items-start'>
                                        <IoIosSettings className='mr-2 text-blue-900 w-5 h-5' />
                                        {t(
                                            'services.injector.services.cleaning'
                                        )}
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div className='mt-5 flex flex-col sm:flex-row mx-4 lg:w-[1200px] lg:mx-auto mx-auto overflow-hidden bg-gradient-to-bl from-neutral-50 to-blue-100 rounded-xl p-6'>
                        <div className='p-2 sm:w-1/2'>
                            <Image
                                ...
                                src='https://res.cloudinary.com/dcbryptkx/image/upload/v1725252853/cp-indoteknik-v3/services/1-1_service_injector_7_xdqacc.png'
                                alt={t('services.injector.imageAlt')}
                                width={900}
                                height={600}
                                priority
                            />
                        ...
                        <div className='sm:p-4 p-2 sm:w-1/2 lg:p-0 lg:w-full flex flex-col '>
                            <div>
                                <h2 className='text-2xl font-semibold text-gray-800'>
                                    {t('services.injector.imageTitle')}
                                </h2>
                                <p className='mt-2 text-md text-gray-800 text-justify'>
                                    {t('services.injector.imageDescription')}
                                </p>
                            </div>
                        </div>
                    </div>
