...
const Fabrication = () => {
    ...
    return (
        <div className='mx-auto mt-10 mb-10'>
            <Head>
                <title>{t('services.fabrication.title')} | Indo Teknik</title>
                <meta
                    name='description'
                    content={t('services.fabrication.imageDescription')}
                />
                <meta
                    name='keywords'
                    content={`${t('services.fabrication.title')}, ${t(
                        'header.services'
                    )} ${t('services.fabrication.title')}, ${t(
                        'header.services'
                    )} Indo Teknik`}
                />
            </Head>
                        ...
                        <div className='sm:p-4 p-2 sm:w-full flex flex-col justify-between'>
                            <div>
                                <p className='mt-2 text-md text-gray-800 text-justify'>
                                    {t('services.fabrication.description')}
                                </p>
                                <ul className='list-disc list-inside mt-2 text-gray-700'>
                                    <li className='flex items-start'>
                                        <IoIosSettings className='mr-2 text-blue-900 w-5 h-5' />
                                        {t(
                                            'services.fabrication.services.build'
                                        )}
                                    </li>
                                    <li className='flex items-start'>
                                        <IoIosSettings className='mr-2 text-blue-900 w-5 h-5' />
                                        {t(
                                            'services.fabrication.services.pipeWelding'
                                        )}
                                    </li>
                                    <li className='flex items-start'>
                                        <IoIosSettings className='mr-2 text-blue-900 w-5 h-5' />
                                        {t(
                                            'services.fabrication.services.repair'
                                        )}
                                    </li>
                                </ul>
                                {t('services.fabrication.equipment')}
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className='sm:p-4 p-2 sm:w-1/2 lg:p-0 lg:w-full flex flex-col '>
                            <div>
                                <h2 className='text-2xl font-semibold text-gray-800'>
                                    {t('services.fabrication.imageTitle')}
                                </h2>
                                <p className='mt-2 text-md text-gray-800 text-justify'>
                                    {t('services.fabrication.imageDescription')}
                                </p>
                            </div>
                        </div>
                    </div>
