...
const Footer = () => {
    ...
    const handleWhatsappClick = () => {
        const phoneNumber = '+628117531881';
    ...
    return (
        <footer className='text-center mb-8 bg-blue-900 pt-5 pb-5 rounded-xl lg:w-[1200px] lg:mx-auto mt-4 ml-4 mr-4 '>
                    ...
                    <div className='w-full lg:w-6/12 px-4 '>
                        <div className='flex flex-wrap items-top mb-6'>
                            <div className='w-full lg:w-6/12 ml-auto '>
                                ...
                                <ul className='flex divide-border flex-row flex-wrap text-gray-200 max-w-2xl leading-tight text-sm font-normal gap-4 cursor-pointer'>
                                    <li className='list-disc hover:text-gray-100 mx-2'>
                                        <Link href='/services/conventional/fuel-injection-pump'>
                                        {t('footer.serviceCategories.list1')}
                                        </Link>
                                    </li>
                                    <li className='list-disc hover:text-gray-100 mx-2'>
                                        <Link href='/services/conventional/nozzle'>
                                        {t('footer.serviceCategories.list2')}
                                        </Link>
                                    </li>
                                    <li className='list-disc hover:text-gray-100 mx-2'>
                                        <Link href='/services/common-rail/supply-pump'>
                                        {t('footer.serviceCategories.list3')}
                                        </Link>
                                    </li>
                                    <li className='list-disc hover:text-gray-100 mx-2'>
                                        <Link href='/services/common-rail/injector'>
                                        {t('footer.serviceCategories.list4')}
                                        </Link>
                                    </li>
                                    <li className='list-disc hover:text-gray-100 mx-2'>
                                        <Link href='/services/electric/eui'>
                                        {t('footer.serviceCategories.list5')}
                                        </Link>
                                    </li>
                                    <li className='list-disc hover:text-gray-100 mx-2'>
                                        <Link href='/services/electric/unit-pump'>
                                        {t('footer.serviceCategories.list6')}
                                        </Link>
                                    </li>
                                    <li className='list-disc hover:text-gray-100 mx-2'>
                                        <Link href='/services/electric/tics'>
                                        {t('footer.serviceCategories.list7')}
                                        </Link>
                                    </li>
                                    <li className='list-disc hover:text-gray-100 mx-2'>
                                        <Link href='/services/fabrication/fabrication'>
                                        {t('footer.serviceCategories.list8')}
                                        </Link>
                                    </li>
                                    <li className='list-disc hover:text-gray-100 mx-2'>
                                        <Link href='/services/fabrication/welding'>
                                        {t('footer.serviceCategories.list9')}
                                        </Link>
                                    </li>
                                    <li className='list-disc hover:text-gray-100 mx-2'>
                                        <Link href='/services/fabrication/lathe'>
                                        {t('footer.serviceCategories.list10')}
                                        </Link>
                                    </li>
                                    <li className='list-disc hover:text-gray-100 mx-2'>
                                        <Link href='/services/fabrication/press'>
