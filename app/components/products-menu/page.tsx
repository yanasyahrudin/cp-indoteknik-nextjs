                        ...
                        >
                            ...
                            {activeSubMenu === 'CommonRail' && (
                                <ul className='absolute left-full top-0 mt-0 w-56 bg-gradient-to-bl from-neutral-50 to-blue-200 text-blue-900 rounded-xl'>
                                    ...
                                    <li>
                                        <Link
                                            href='/products/fuel-injection-systems/common-rail/common-rail-pipe'
                                            className='block px-4 py-2'
                                        >
                                            {t('Common Rail Pipe')}
                                        </Link>
                        ...
                        >
                            ...
                            {activeSubMenu === 'VP44' && (
                                <ul className='absolute left-full top-0 mt-0 w-56 bg-gradient-to-bl from-neutral-50 to-blue-200 text-blue-900 rounded-xl'>
                                    <li>
                                        <Link
                                            href='/products/fuel-injection-systems/vp44/distributor-pump'
                                            className='block px-4 py-2'
                                        >
                                            Distributor Pump
                                        </Link>
                        ...
                        >
                            ...
                            {activeSubMenu === 'Electric' && (
                                <ul className='absolute left-full top-0 mt-0 w-56 bg-gradient-to-bl from-neutral-50 to-blue-200 text-blue-900 rounded-xl'>
                                    ...
                                    <li>
                                        <Link
                                            href='/products/fuel-injection-systems/electric/unit-pump'
                                            className='block px-4 py-2'
                                        >
                                            Unit Pump
                                        </Link>
            ...
            >
                ...
                {activeMenu === 'AutomotiveAftermarket' && (
                    <ul className='absolute left-full top-0 mt-0 w-56 bg-gradient-to-bl from-neutral-50 to-blue-200 text-blue-900 rounded-xl'>
                        <li>
                            <Link
                                href='/products/automotive-aftermarket/battery'
                                className='block px-4 py-2'
                            >
                                {t('Battery')}
                            </Link>
                        ...
                        <li>
                            <Link
                                href='/products/automotive-aftermarket/brake'
                                className='block px-4 py-2'
                            >
                                {t('Brake')}
                            </Link>
                        ...
                        <li>
                            <Link
                                href='/products/automotive-aftermarket/bulb-lighting'
                                className='block px-4 py-2'
                            >
                                {t('Bulb and Lighting')}
                            </Link>
                        ...
                        <li>
                            <Link
                                href='/products/automotive-aftermarket/filter'
                                className='block px-4 py-2'
                            >
                                Filter
                            </Link>
                        ...
                        <li>
                            <Link
                                href='/products/automotive-aftermarket/gasoline-system'
                                className='block px-4 py-2'
                            >
                                Gasoline System
                            </Link>
                        ...
                        <li>
                            <Link
                                href='/products/automotive-aftermarket/horn'
                                className='block px-4 py-2'
                            >
                                {t('Horn')}
                            </Link>
                        ...
                        <li>
                            <Link
                                href='/products/automotive-aftermarket/relay'
                                className='block px-4 py-2'
                            >
                                Relay
                            </Link>
                        ...
                        <li>
                            <Link
                                href='/products/automotive-aftermarket/spark-plug'
                                className='block px-4 py-2'
                            >
                                {t('Spark Plug')}
                            </Link>
                        ...
                        <li>
                            <Link
                                href='/products/automotive-aftermarket/wiper'
                                className='block px-4 py-2'
                            >
                                Wiper
                            </Link>
            ...
            >
                ...
                {activeMenu === 'OtherProducts' && (
                    <ul className='absolute left-full top-0 mt-0 w-56 bg-gradient-to-bl from-neutral-50 to-blue-200 text-blue-900 rounded-xl'>
                        <li>
                            <Link
                                href='/products/other-products/ecu'
                                className='block px-4 py-2'
                            >
                                ECU
                            </Link>
                        ...
                        <li>
                            <Link
                                href='/products/other-products/starter-alternator'
                                className='block px-4 py-2'
                            >
                                Starter & Alternator
                            </Link>
                        ...
                        <li>
                            <Link
                                href='/products/other-products/power-tool'
                                className='block px-4 py-2'
                            >
                                Power Tool
                            </Link>
