import ProductSlideClient from './ProductSlideClient';

export const revalidate = 60;

// export const metadata = {
//     title: 'Produk Indo Teknik - Spare Part Diesel & Servis',
//     description:
//         'Temukan berbagai produk unggulan Indo Teknik seperti Fuel Injection Pump, Injector, Battery, Turbo Charger, dan lainnya. Solusi lengkap untuk kebutuhan spare part diesel dan servis kendaraan Anda.',
//     alternates: {
//         canonical:
//             'https://indo-teknik.com/products/components/product-slide',
//     },
//     keywords: [
//         'Indo Teknik',
//         'Spare Part Diesel',
...
//         title: 'Produk Indo Teknik - Spare Part Diesel & Servis',
//         description:
//             'Lihat katalog produk Indo Teknik: Fuel Injection Systems, Automotive Aftermarket, dan produk lainnya untuk kebutuhan kendaraan Anda.',
//         url: 'https://indo-teknik.com/products/components/product-slide',
//         type: 'website',
//         images: [
//             {
...
//         title: 'Produk Indo Teknik - Spare Part Diesel & Servis',
//         description:
//             'Temukan berbagai produk unggulan Indo Teknik untuk kebutuhan spare part dan servis kendaraan Anda.',
//         images: [
...
export default function ProductSlidePage() {
    ...
    const commonRailPipe =
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1735813566/cp-indoteknik-v3/products/common_rail_pipe_uj898_bvnpin.png';
    ...
    const categories = {
        'Fuel Injection Systems': [
            ...
            {
                id: 7,
                name: 'Common Rail Pipe',
                imageUrl: commonRailPipe,
                link: '/products/fuel-injection-systems/common-rail/common-rail-pipe',
            },
        ],
        'Automotive Aftermarket': [
            {
    ...
    return <ProductSlideClient categories={categories} />;
}
