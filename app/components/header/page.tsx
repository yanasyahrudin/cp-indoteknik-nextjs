...
import ServicesMenu from '../services-menu/page';
import ProductsMenu from '../products-menu/page';
import Sidebar from '../sidebar-mobile/page';
        ...
        <>
            ...
            <nav className='sticky top-4 z-50 flex items-center justify-between p-3 bg-white bg-opacity-90 backdrop-blur shadow-md rounded-xl lg:w-[1000px] lg:mx-auto ml-4 mr-4 mb-4'>
                ...
                <ul className='hidden lg:flex space-x-4 p-4 mx-auto'>
                    ...
                    <li className='relative group'>
                        <a className={`${activeLink.startsWith('/services') ? 'text-blue-900 font-semibold' : 'text-blue-900'} font-normal flex justify-between`}>
                    ...
                    <li>
                        <Link
                            href='/blog'
                            className={`${activeLink.startsWith('/blog') ? 'text-blue-900 font-semibold' : 'text-blue-900'} font-normal `}
                        >
                            Blog
                        </Link>
                    </li>
