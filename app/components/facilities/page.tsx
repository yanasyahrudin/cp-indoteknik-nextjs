...
const Facilities = () => {
  ...
  const [selectedFacilityIndex, setSelectedFacilityIndex] = useState<
    number | null
  >(null);
  ...
  const facilities = [
    {
      ...
      image:
        "https://res.cloudinary.com/dcbryptkx/image/upload/w_900/v1723450058/cp-indoteknik-v3/facilities/Untitled_design_hetwyi.png",
    },
    {
      key: "home.facilities.fac2",
      image:
        "https://res.cloudinary.com/dcbryptkx/image/upload/w_900/v1723451552/cp-indoteknik-v3/facilities/Untitled_design_2_vnh5ri.png",
    },
    {
      key: "home.facilities.fac3",
      image:
        "https://res.cloudinary.com/dcbryptkx/image/upload/w_900/v1723451787/cp-indoteknik-v3/facilities/Untitled_design_3_nfuf44.png",
    },
    {
      key: "home.facilities.fac4",
      image:
        "https://res.cloudinary.com/dcbryptkx/image/upload/w_900/v1723452789/cp-indoteknik-v3/facilities/Untitled_design_4_matxg1.png",
    },
    {
      key: "home.facilities.fac5",
      image:
        "https://res.cloudinary.com/dcbryptkx/image/upload/w_900/v1723453919/cp-indoteknik-v3/facilities/Untitled_design_6_gilnlc.png",
    },
    {
      key: "home.facilities.fac6",
      image:
        "https://res.cloudinary.com/dcbryptkx/image/upload/w_900/v1723456834/cp-indoteknik-v3/facilities/Untitled_design_8_dborw0.png",
    },
    {
      key: "home.facilities.fac7",
      image:
        "https://res.cloudinary.com/dcbryptkx/image/upload/w_900/v1723455978/cp-indoteknik-v3/facilities/Untitled_design_7_ubhbrw.png",
    },
    {
      key: "home.facilities.fac8",
      image:
        "https://res.cloudinary.com/dcbryptkx/image/upload/w_900/v1723457749/cp-indoteknik-v3/facilities/Untitled_design_9_afzpqt.png",
    },
    {
      key: "home.facilities.fac9",
      image:
        "https://res.cloudinary.com/dcbryptkx/image/upload/w_900/v1723518301/cp-indoteknik-v3/facilities/Untitled_design_11_nmmmut.png",
    },
    {
  ...
  const openModal = (index: number) => {
    if (index === 9) {
      router.push("/test-bench-and-fabrication-machines");
      return;
    }
  ...
  const showNextFacility = () => {
    setSelectedFacilityIndex((prevIndex) => {
  ...
  const showPreviousFacility = () => {
    setSelectedFacilityIndex((prevIndex) => {
      const current = prevIndex === null ? 0 : prevIndex;
      return (current - 1 + facilities.length) % facilities.length;
    });
  };
