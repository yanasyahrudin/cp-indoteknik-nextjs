            ...
            >
                ...
                {activeService === 'Conventional' && (
                    <ul className='absolute left-full top-0 mt-0 w-48 bg-gradient-to-bl from-neutral-50 to-blue-200 text-blue-900 rounded-xl'>
                        ...
                        <li>
                            <Link
                                href='/services/conventional/nozzle'
                                className='block px-4 py-2'
                            >
                                Nozzle
                            </Link>
            ...
            >
                ...
                {activeService === 'Common Rail' && (
                    <ul className='absolute left-full top-0 mt-0 w-48 bg-gradient-to-bl from-neutral-50 to-blue-200 text-blue-900 rounded-xl'>
                        <li>
                            <Link
                                href='/services/common-rail/supply-pump'
                                className='block px-4 py-2'
                            >
                                Supply Pump
                            </Link>
            ...
            >
                ...
                {activeService === 'Electric' && (
                    <ul className='absolute left-full top-0 mt-0 w-48 bg-gradient-to-bl from-neutral-50 to-blue-200 text-blue-900 rounded-xl'>
                        ...
                        <li>
                            <Link
                                href='/services/electric/unit-pump'
                                className='block px-4 py-2'
                            >
                                Unit Pump
                            </Link>
            ...
            >
                ...
                {activeService === 'Fabrication' && (
                    <ul className='absolute left-full top-0 mt-0 w-48 bg-gradient-to-bl from-neutral-50 to-blue-200 text-blue-900 rounded-xl'>
                        <li>
                            <Link
                                href='/services/fabrication/fabrication'
                                className='block px-4 py-2'
                            >
                                {t('Fabrication')}
                            </Link>
                        ...
                        <li>
                            <Link
                                href='/services/fabrication/welding'
                                className='block px-4 py-2'
                            >
                                {t('Welding')}
                            </Link>
                        ...
                        <li>
                            <Link
                                href='/services/fabrication/press'
                                className='block px-4 py-2'
                            >
                                {t('Press')}
                            </Link>
