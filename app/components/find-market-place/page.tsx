        ...
        <div className='gap-4 justify-content items-center flex '>
            ...
            <div className='relative inline-block text-left '>
                <div className='group'>
                    ...
                    <div className='absolute left-0 w-40 origin-top-left divide-y divide-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-300 z-50'>
                        <div className='absolute left-0 mt-2 w-48 md:w-44 xs:w-40 invisible group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0'>
                            <div className='bg-gradient-to-bl from-neutral-50 to-blue-200 rounded-xl shadow-md'>
                                <a
                                    href='https://tokopedia.link/qoZIKIkdcNb'
                                    target='_blank'
                                    rel='noopener noreferrer'
                                    className='block px-4 py-2 text-sm text-blue-900 flex justify-between items-center'
                                >
                                    Tokopedia
