import SafeWorkProjectCompletedChooseOurSupplyPumpClient from './SafeWorkProjectCompletedChooseOurSupplyPumpClient';
...
export default function SafeWorkProjectCompletedChooseOurSupplyPumpPage() {
    const currentPostTitle =
        'Kerja Aman! Proyek Tuntas! Pilih Supply Pump Kami Untuk Komatsu PC-70';
