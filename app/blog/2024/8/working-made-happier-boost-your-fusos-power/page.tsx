import SafeWorkProjectCompletedChooseOurSupplyPumpClient from './WorkingMadeHappierBoostYourFusosPowerClient';
...
export default function SafeWorkProjectCompletedChooseOurSupplyPumpPage() {
    const currentPostTitle =
        'Kerja Makin Happy! Tenaga Fuso Anda Semakin Optimal dengan Sparepart Ini';
