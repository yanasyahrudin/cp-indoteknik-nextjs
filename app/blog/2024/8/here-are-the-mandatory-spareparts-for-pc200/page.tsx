import HowToSolveInjectorProblemsOnAMitsubishiTriton2500ccClient from './HereAreTheMandatorySparepartsForPC200Client';
...
export default function HowToSolveInjectorProblemsOnAMitsubishiTriton2500ccPage() {
    const currentPostTitle =
        'Inilah Sparepart Wajib untuk PC200: Supply Pump Komatsu PC200-8!';
