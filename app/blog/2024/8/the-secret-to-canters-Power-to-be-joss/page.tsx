import SafeWorkProjectCompletedChooseOurSupplyPumpClient from './TheSecretToCantersPowerToBeJossClient';
...
export default function SafeWorkProjectCompletedChooseOurSupplyPumpPage() {
    const currentPostTitle =
        'Rahasia Tenaga Canter Jadi Joss? Delivery Valve Itech Solusinya!';
