import SafeWorkProjectCompletedChooseOurSupplyPumpClient from './NozzleJosMaximumEfficiencyForToyotaDyna130htClient';
...
export default function SafeWorkProjectCompletedChooseOurSupplyPumpPage() {
    const currentPostTitle =
        'Nozzle Jos! Efisiensi Maksimal untuk Toyota Dyna 130HT';
