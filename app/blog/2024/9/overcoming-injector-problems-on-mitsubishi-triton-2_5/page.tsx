import HowToSolveInjectorProblemsOnAMitsubishiTriton2500ccClient from './OvercomingInjectorProblemsOnMitsubishiTriton2_5Client';
...
export default function HowToSolveInjectorProblemsOnAMitsubishiTriton2500ccPage() {
    const currentPostTitle =
        'Mengatasi Masalah Injector Pada Mitsubishi Triton 2.5 – Asap Putih dan Mesin Mati Mendadak';
