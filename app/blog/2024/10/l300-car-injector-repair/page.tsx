import L300CarInjectorRepairPartIIClient from './L300CarInjectorRepairClient';
...
export default function L300CarInjectorRepairPartIIPage() {
    const currentPostTitle =
        'Perbaikan Injector Mitsubishi L300 di Pekanbaru: Solusi untuk Masalah Tenaga dan Emisi';
