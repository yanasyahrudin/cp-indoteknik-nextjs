import CaterpillarC9InjectorServiceAndCalibrationInPekanbaruIndoTeknik from './CaterpillarC9InjectorServiceAndCalibrationInPekanbaruIndoTeknik';
...
export default async function DetailedColtDieselNjectionPumpPage() {
    const currentPostTitle =
        'Servis dan Kalibrasi Injektor Caterpillar C9 di Pekanbaru - Indo Teknik';
    ...
    return (
        <CaterpillarC9InjectorServiceAndCalibrationInPekanbaruIndoTeknik
