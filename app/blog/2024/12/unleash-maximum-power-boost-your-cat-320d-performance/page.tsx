        ...
        return (
            <div className='my-10 lg:flex max-w-[1200px] lg:mx-auto gap-8 rounded-xl md:mx-4 mx-4'>
                <Head>
                    ...
                    <meta
                        name='description'
                        content='Awet dan Tahan Lama: Performa Mesin Terjaga, Hemat Biaya Perawatan, dan Bahan Bakar Mesin yang handal adalah investasi jangka panjang. Dengan menggunakan Injector CAT 320D, performa mesin diesel Anda tetap terjaga dalam kondisi optimal. Selain itu, efisiensi bahan bakar yang lebih baik membuat pengeluaran harian menjadi lebih hemat, sekaligus mengurangi biaya perawatan yang sering muncul karena komponen yang cepat aus.'
                    />
                    <meta
                        name='keywords'
                        content='injector cat 320d, caterpillar, itech persada nusantara, indo teknik, common rail, injector'
                    />
                </Head>
