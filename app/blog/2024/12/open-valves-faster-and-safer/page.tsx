    ...
    return (
        <div className='my-16 lg:flex max-w-[1200px] lg:mx-auto gap-8 rounded-xl md:mx-4 mx-4'>
            <Head>
                ...
                <meta
                    name='description'
                    content='Apakah Anda sedang mencari solusi praktis dan aman untuk membuka valve injektor pada kendaraan Anda? Itech Tool Injector Ford 2.2 adalah jawabannya! Dengan desain yang presisi dan material berkualitas tinggi, alat ini dirancang untuk mempermudah pekerjaan Anda tanpa mengorbankan kualitas hasil.'
                />
                <meta
                    name='keywords'
                    content='tool itech, itech smart choice, spare part riau, indo teknik, itech persada nusantara, tool injector ford 2.2, common rail, injector'
                />
            </Head>
