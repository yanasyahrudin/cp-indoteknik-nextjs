                        ...
                        <div className='lg:flex md:flex gap-6 text-justify'>
                            <div>
                                <h2 className='text-xl font-semibold text-gray-800 mt-4 mb-2'>
                                    {t(
                                        'Mengapa Memilih VALVE G4 HILUX 2GD ITECH?',
                                    )}
                                </h2>
                                ...
                                <div className='ml-4'>
                                    <h3 className='text-lg font-semibold text-gray-800 mt-4 mb-2'>
                                        {t(
                                            '1. Harga Terjangkau, Kualitas Premium',
                                        )}
                                    </h3>
                    ...
                    <div>
                        ...
                        <div className='gap-6 text-justify'>
                            <p className='text-gray-600 mb-4'>
                                ...
                                <strong>
                                    {' '}
                                    <Link className='font-bold text-blue-900 underline' href="/products/fuel-injection-systems/common-rail/injector">
                                         {t('VALVE G4 HILUX 2GD ITECH')}.{' '}
                                    </Link>
                                </strong>
                                {t('Tersedia eksklusif di')}{' '}
                                <strong>{t('INDO TEKNIK.')}</strong>{' '}
                                <Link className='font-bold text-blue-900 underline' href="/contact">
                                    {t('Hubungi kami')}
                                </Link>{' '}
                                {t(
                                    'untuk pemesanan online atau kunjungi alamat',
                                )}{' '}
                               <strong>{t('INDO TEKNIK')}</strong>{' '}
                                {t(
                                    'di',
                                ...
                                <Link className='font-bold text-blue-900 underline' href="https://maps.app.goo.gl/dsXQnx9m83xDV4rcA">
                                {t(
