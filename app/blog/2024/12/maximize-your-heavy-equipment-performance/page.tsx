    ...
    return (
        <div className='my-16 lg:flex max-w-[1200px] lg:mx-auto gap-8 rounded-xl md:mx-4 mx-4'>
            <Head>
                ...
                <meta
                    name='description'
                    content='Apakah Anda ingin meningkatkan performa alat berat Anda sambil tetap menghemat biaya operasional? Injection Pump CAT 320D adalah solusi terbaik untuk kebutuhan alat berat Anda. Dirancang untuk memberikan kinerja maksimal, produk ini telah menjadi pilihan utama bagi para profesional di industri alat berat.'
                />
                <meta
                    name='keywords'
                    content='injection pump cat 320D, fuel injection pump, conventional injection pump, spare part diesel, indo teknik, diesel center'
                />
            </Head>
