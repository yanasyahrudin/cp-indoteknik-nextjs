        ...
        return (
            <div className='my-16 lg:flex max-w-[1200px] lg:mx-auto gap-8 rounded-xl md:mx-4 mx-4'>
                <Head>
                    ...
                    <meta
                        name='description'
                        content='Apakah Anda sedang mencari solenoid injektor berkualitas tinggi untuk mesin Kobelco SK200 Anda? Kami punya solusi terbaik untuk Anda!'
                    />
                    <meta
                        name='keywords'
                        content='Kobelco SK200, solenoid injektor kobelco, common rail, injector part, indo teknik, diesel part'
                    />
                </Head>
