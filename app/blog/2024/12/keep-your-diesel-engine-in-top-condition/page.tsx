        ...
        return (
            <div className='my-16 lg:flex max-w-[1200px] lg:mx-auto gap-8 rounded-xl md:mx-4 mx-4'>
                <Head>
                    ...
                    <meta
                        name='description'
                        content='Mesin diesel yang andal dan efisien adalah kunci untuk produktivitas dan performa terbaik. Salah satu komponen vital yang memengaruhi kinerja mesin diesel adalah pipa common rail. Dalam artikel ini, kita akan membahas mengapa Pipa Common Rail Kobelco SK130 adalah pilihan terbaik untuk menjaga mesin diesel tetap dalam kondisi prima.'
                    />
                    <meta
                        name='keywords'
                        content='pipa common rail, kobelco sk130, spare part riau, indo teknik, common rail, injector'
                    />
                </Head>
